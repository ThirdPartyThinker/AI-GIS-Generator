...
".join([f"- {k}" for k in GEOJSON_SOURCES.keys()])
    ...
    message = client.messages.create(
        ...
        messages=[{
            "role": "user",
            "content": f"""You are a GIS mapping assistant. Convert this request into JSON only.
...
{{
    ...
    return {
        "map_type": "marker", "region_type": None,
        "state_filter": None, "region_name_column": None,
        "data_column": None, "title": "My Map",
        "color_scheme": "YlOrRd"
    }
